...
import org.taranco.booking.port.output.BookingCancellationEventPublisher;
...
public class BookingCancellator {
    ...
    public void publishCancellingBookingRequest(BookingCancellingEvent event) {
        ...
        log.info("Started cancellation process of booking with id: {}", event.bookingId().getId().toString());
